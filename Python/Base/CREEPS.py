...
statusbar = ttk.Label(root, text="Emniem Recomended", anchor=W, font='Arial 8 italic')
statusbar.pack(side=BOTTOM, fill=X)
statusbar1 = ttk.Label(root, text="JK JK do wtv u want", anchor=W, font='Arial 8 italic')
...
rtframe = Frame(root,bg="#121212")
rtframe.pack(pady=30,padx=20)
topframe = Frame(rtframe,bg="#121212")
topframe.pack()
root.style = ttk.Style()
#root.style.theme_use("clam")
...
def mute_music():
    ...
    if muted:
        ...
        scale.set(0)
        muted = TRUE
middleframe = Frame(rtframe,bg="#121212")
